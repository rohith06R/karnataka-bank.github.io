...
<div class="col-md act">
                   ...
                   <br>
                   <a href="transactionhistory.php"><button style="background-color : #FF0000;">Dashboard</button></a>
                 </div>
                 <div class="col-md act">
                   <img src="img/user reg.jpg" class="img-fluid">
                   <br>
                 ...
                 <div class="col-md act">
                   ...
                   <br>
                   <a href="transfermoney.php"><button style="background-color : #FF0000;">Transaction History</button></a>
                 </div>
